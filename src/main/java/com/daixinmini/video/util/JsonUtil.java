...
public class JsonUtil {
    public static ObjectMapper buildObjectMapper() throws JsonParseException, JsonMappingException, IOException {
    ...
    public static String getNodeAsString(JsonNode node, String nodeName) {
